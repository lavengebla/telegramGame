...
public abstract class AbstractDeleteHandler {
     ...
     */
    public final List<DeleteMessage> authorizeAndHandle(User user, Long chatId, String message, int id) {
     ...
     */
    protected abstract List<DeleteMessage> handle(User user, Long chatId ,String message, int id);

    /**
     * Обрабатываем команду, если пользователь не авторизован
     */
    private List<DeleteMessage> handleUnauthorized(User user, Long chatId ,String message) {
