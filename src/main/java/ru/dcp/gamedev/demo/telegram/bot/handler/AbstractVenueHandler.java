 ...
 */
@Slf4j
public abstract class AbstractVenueHandler {
    ...
    protected AbstractVenueHandler(NotificationService notificationService) {
     ...
     */
    public final List<SendVenue> authorizeAndHandle(User user, Long chatId, String message) {
        /**
         *someval = (min >= 2) ? 2 : 1;
     ...
     * @return
     */
    protected abstract List<SendVenue> handle(User user, Long chatId , String message);

    /**
     * Обрабатываем команду, если пользователь не авторизован
     */
    private List<SendVenue> handleUnauthorized(User user, Long chatId ,String message) {
